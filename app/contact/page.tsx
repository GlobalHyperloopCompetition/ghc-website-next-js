...
export default function ContactFormWithSocialButtons() {
    ...
    useEffect(() => {
        window.scrollTo(0, 0)
        setInput(prevInput => ({ ...prevInput, email: query.get('email') || "" }))
    }, [query])
        ...
        return isVisible ? (
            <Alert status='success'>
                ...
                <Box>
                    ...
                    <AlertDescription>
                        Your message has been recieved, It will be reviewed by our team. We will reach out to you through email asap!
                    </AlertDescription>
                </Box>
                <CloseButton
                    ...
                    <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
                        ...
                        <Stack
                            ...
                            <Stack
                                ...
                                <Box as="a" href="https://www.instagram.com/ghc_india/" target="_blank">
                                    <IconButton
                                ...
                                <Box as="a" href="https://www.linkedin.com/company/global-hyperloop-competition-iitm/mycompany/" target="_blank">
                                    <IconButton
                                        aria-label="linkedin"
                                        variant="ghost"
                                        size="lg"
                                ...
                                <VStack spacing={5}>
                                    <FormControl isRequired>
                                        ...
                                        <InputGroup>
                                            ...
                                            <Input value={input.name} onChange={handleChange} focusBorderColor='red.400' type="text" name="name" placeholder="Your Name" />
                                        </InputGroup>
                                    </FormControl>
                                    ...
                                    <FormControl isRequired>
                                        ...
                                        <InputGroup>
                                            ...
                                            <Input value={input.email} onChange={handleChange} focusBorderColor='red.400' type="email" name="email" placeholder="Your Email" />
                                        </InputGroup>
                                    </FormControl>
                                    ...
                                    {error && <Text align={'center'} color={'red.600'} pt={2}>
                                        {error}
                                    </Text>}

                                    <motion.div whileTap={{ scale: 0.95 }} whileHover={{ scale: 1.05 }} style={{ width: "100%" }}>
                                        <Button
                                            colorScheme="red"
                                            bg="red.400"
                                            color="white"
